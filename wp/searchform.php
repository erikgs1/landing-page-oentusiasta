<div class="search-button">
    ...
    <form role="search" method="get" class="search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
        ...
        <label>
            <input type="search" class="search-field input-box-shadow " placeholder="<?php echo esc_attr_x( 'Procure por algo', 'placeholder', 'oentusiasta' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
        </label>
